...
import { ArrowRight, Download, FileText, MapPin, Package, Truck } from "lucide-react";
...
const contentByLang: Record<Lang, LocaleContent> = {
  de: {
    ...
    trustBar: [
      ...
      "Technische Datenblätter verfügbar",
    ],
  ...
  en: {
    ...
    hero: {
      headline: "High-Quality PU & PVC Automotive Materials",
      subheadline: "For interior specialists, upholstery businesses, and vehicle converters across Europe.",
      trustLine: "In-stock from 1 meter · 2–4 day delivery across Europe · Technical documentation available",
  ...
  ru: {
    ...
    trustBar: [
      ...
      "Технические datasheets доступны",
    ],
    ...
    <main className="min-h-screen bg-[#111111] text-[#ECEAE4]">
      ...
      <section id="home" className="relative overflow-hidden border-b border-white/10 bg-[#0D0D0D]">
        <div className="relative aspect-[16/9] min-h-[60vh] w-full md:min-h-[72vh]">
          <img
            src="https://images.unsplash.com/photo-1471478331149-c72f17e33c73?auto=format&fit=crop&w=2400&q=80"
      ...
      <section className="border-b border-white/10 bg-white/[0.03]">
        <div className="mx-auto grid max-w-7xl gap-3 px-6 py-5 md:grid-cols-2 lg:grid-cols-5">
      ...
      <section id="about" className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid gap-8 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div className="space-y-3 rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-sm text-white/80">
            <a href="#" className="flex items-center justify-between rounded-lg border border-white/10 px-3 py-2 transition hover:border-white/35">
              {content.about.download} <Download size={15} />
            </a>
            <a href="#materials" className="flex items-center justify-between rounded-lg border border-white/10 px-3 py-2 transition hover:border-white/35">
              {content.about.chart} <ArrowRight size={15} />
            </a>
      ...
      <section className="mx-auto max-w-7xl px-6 py-14">
        <h3 className="text-3xl font-semibold">{content.technical.title}</h3>
        <p className="mt-4 max-w-4xl text-white/75">{content.technical.text}</p>
      </section>

      <section className="border-y border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-7xl px-6 py-14">
          <h3 className="text-3xl font-semibold">{content.principles.title}</h3>
          <p className="mt-4 text-white/75">{content.principles.intro}</p>
